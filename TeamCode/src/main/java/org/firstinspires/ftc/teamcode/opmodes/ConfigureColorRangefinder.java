...
public class ConfigureColorRangefinder extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ColorRangefinder crf = new ColorRangefinder(hardwareMap.get(RevColorSensorV3.class, "ColorSensor"));
        waitForStart();
        ...
        /*  pin0 --> purple
            pin1 --> green */
        crf.setPin0Digital(ColorRangefinder.DigitalMode.HSV, 141 / 360.0 * 255, 190 / 360.0 * 255); // purple
...
class ColorRangefinder {
    ...
    /**
     * Configure Pin 0 to be in digital mode, and add a threshold.color
