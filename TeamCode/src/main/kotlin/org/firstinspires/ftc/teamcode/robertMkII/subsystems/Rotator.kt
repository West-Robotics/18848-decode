...
class Rotator(hardwareMap: HardwareMap) {
    ...
    private val motor = NgMotor(hardwareMap, "rotator", DcMotorSimple.Direction.FORWARD, DcMotor.ZeroPowerBehavior.BRAKE)
    private val encoder = NgEncoder(hardwareMap, "rotator", DcMotorSimple.Direction.FORWARD, 537.7)
